...
Future baseline changes must follow `REPOSITORY-POLICY.md`: canonical re-import
is the default repair path; a bounded privacy-redacted derivative is permitted
only under the separately recorded non-semantic redaction transaction.
